 ...
 */
class Proprietaire extends \NG\GestionnaireBundle\Entity\Proprietaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'id', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'sexe', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'nom', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'prenom', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'tel', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'email', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'adresse', '' . "\0" . 'NG\\GestionnaireBundle\\Entity\\Proprietaire' . "\0" . 'ville'];
        }
