...
namespace Proxies\__CG__\NG\AdministrateurBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Entreprise extends \NG\AdministrateurBundle\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'id', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'nom', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'type', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'tel', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'email', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'adresse', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'logo', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Entreprise' . "\0" . 'ville'];
        }
