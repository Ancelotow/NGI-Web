 ...
 */
class Utilisateur extends \NG\AdministrateurBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'dateNaissance', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'tel', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'sexe', '' . "\0" . 'NG\\AdministrateurBundle\\Entity\\Utilisateur' . "\0" . 'poste'];
        }
